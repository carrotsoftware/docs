...
- `Tracked Data` - используется для вывода только трекинг данных.
...
![Workflow_WebPlaylist](..\images\3998\image_006.jpg "Workflow - WebPlaylist")
...
- `Save As New` - сохранить изменения стейта в новый шаблон.
...
![Settings_Carrot Engine_GPIO_MIDI_Macro](..\images\3998\image_055.jpg "Carrot Engine - GPIO, MIDI, Macro")

4. Раскройте меню `Playlist`, чтобы выбрать плейлист для управления через контроллер.

![Settings_Carrot Engine_GPIO_MIDI_Macro](..\images\3998\image_056.jpg "Carrot Engine - GPIO, MIDI, Macro")

5. Из региона `Playlist Events` перенесите события в регион `Assigned Events`.

![Settings_Carrot Engine_GPIO_MIDI_Macro](..\images\3998\image_057.jpg "Carrot Engine - GPIO, MIDI, Macro")
...
![Settings_Carrot Engine_GPIO_MIDI_Macro](..\images\3998\image_058.jpg "Carrot Engine - GPIO, MIDI, Macro")
...
>![Settings_Carrot InputDevices](..\images\3998\image_059.jpg "Carrot InputDevices")
...
![Settings_Carrot InputDevices](..\images\3998\image_060.jpg "Carrot InputDevices")
