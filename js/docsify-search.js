!(function () {
            ...
            d &&
              (p[d]
                ? p[d].body
                  ...
                  : ((e.text = y(e)),
                    (e.text = v(e)),
                    (p[d].body = p[d].body ? p[d].body + e.text : e.text))
    ...
    for (var i = 0; i < t.length; i++)
      !(function (e) {
        ...
        d &&
          ...
          0 < r &&
            ((e = { title: s, content: l ? o : "", url: e, score: r }),
            n.push(e)));
      })(i);
    ...
    if (!e)
      return (
        ...
        void (
          ...
          (i && i.classList.remove("hide"), n && n.classList.remove("hide"))
        )
      );
    var e = o(e),
      r = "";
  ...
  window.$docsify.plugins = [].concat(function (e, n) {
    var t = Docsify.util,
      a = n.config.search || w;
    Array.isArray(a)
      ? (w.paths = a)
