...
![BMD Install](../images/1.1.6/initial-setup/is-tp-bmd-install.png)
...
![NVIDIA Control Panel Location](../images/1.1.6/initial-setup/is-os-nvidia-cp-location.png)
...
![NVIDIA Control Panel Settings](../images/1.1.6/initial-setup/is-os-nvidia-cp-settings.png)
...
![Power Supply Location](../images/1.1.6/initial-setup/is-os-power-supply-location.png)

- **Шаг № 3**. В разделе **"Основные схемы"** выбрать параметр **"Высокая производительность"** и закрыть приложение **"Панель управления"**.

![Power Supply Scheme](../images/1.1.6/initial-setup/is-os-power-supply-scheme.png)
...
![Graphics Settings](../images/1.1.6/initial-setup/is-os-graphics-settings.png)
...
![Carrot Folder Contents](../images/1.1.6/initial-setup/is-ci-carrot-folder-contents.png)
