...
![Null Layer](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-null-layer.jpg)

###### Solid Layer

Аналогично **АЕ**. Отличие только в том, что в **Carrot** этот тип слоя рисуется в режиме `Bicubic sampling` (*пример на рис. ниже*)

![Solid Layer](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-solid-layer.jpg)

###### Shape Layer

Для работы с **Shape Layers** их необходимо перед экспортом из After Effects в Carrot конвертировать в `Bezier Path`

![Converting to Bezier Path](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-shape-layer-1.jpg)
...
![Stroke](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-shape-layer-2.jpg)
...
![Masks](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-shape-layer-3.jpg)
...
![Scaled Layer](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-shape-layer-4.jpg)
...
![Interpret Footage](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-media-layer-1.jpg)

![Loop Times](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-media-layer-2.jpg)
...
![Frame Rate](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-media-layer-3.jpg)
...
![Distance Example 1](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-3d-layer-1.jpg)

![Distance Example 2](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-3d-layer-2.jpg)

![Distance Example 3](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-3d-layer-3.jpg)

![Distance Example 4](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-3d-layer-4.jpg)
...
![Intersect](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-mask-layer-1.gif)
...
![None Mask](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-mask-layer-2.jpg)
...
![Key Animation](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-layer-animation.jpg)
...
![Posterize Time](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-effect-posterize-time.jpg)
...
![Text Layer](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-text-fonts.jpg)
...
![Media Resources](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-media-resources.jpg)
...
![Placeholder 1](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-media-SDI-1.jpg)

![Placeholder 2](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-media-SDI-2.gif)

![Placeholder 3](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-media-SDI-3.jpg)
...
![Extended Script](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-expression.jpg)
...
![Optimization Rule 1](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-optimization-rules-1.jpg)

Используем вместо нескольких видео - **1 видеоатлас**.

![Optimization Rule 2](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-optimization-rules-2.jpg)

##### Уборка мусора

Перед экспортом надо нажать на головную композицию и сделать `File - Dependencies - Reduce Project`.

![Reduce Project](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-optimization-reduce-project.jpg)
...
![Compozition Size 1](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-optimization-comp-size-1.jpg)

![Compozition Size 2](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-optimization-comp-size-2.jpg)
...
![Curves](../images/1.1.6/working-with-third-party-software/after-effects/ae-main-optimization-masks.jpg)
...
![Directory](../images/1.1.6/working-with-third-party-software/after-effects/ae-plugin-aegp-directory.png)

2. Запустите **InitSettings** в папке `Carrot/Bin` от имени администратора.

![Init Settings](../images/1.1.6/working-with-third-party-software/after-effects/ae-plugin-installation.png)
...
![Composition](../images/1.1.6/working-with-third-party-software/after-effects/ae-settings-composition-project.png)

4. Выберите меню **Composition** > **Composition Settings...** или нажмите клавиши **CTRL**+**K**.

![Composition Settings](../images/1.1.6/working-with-third-party-software/after-effects/ae-settings-composition-settings.png)

5. Проверьте разрешение и частоту кадров композиции.

![Resolution 1](../images/1.1.6/working-with-third-party-software/after-effects/ae-settings-composition-resolution-1.png)
...
>
> ![Resolution 2](../images/1.1.6/working-with-third-party-software/after-effects/ae-settings-composition-resolution-2.png)

6. Удалите из проекта все неиспользуемые элементы. Для этого выберите **File** > **Dependencies** > **Remove Unused Footage**.

![Remove Unused Footage](../images/1.1.6/working-with-third-party-software/after-effects/ae-settings-composition-unused-footage.png)

#### Указание точек входа и выхода анимации

![Animation Markers](../images/1.1.6/working-with-third-party-software/after-effects/ae-markers-main.png)
...
![Add Marker](../images/1.1.6/working-with-third-party-software/after-effects/ae-markers-add-marker.png)

2. Щелкните правой кнопкой мыши по добавленному маркеру и выберите **Settings...**

![Marker Settings](../images/1.1.6/working-with-third-party-software/after-effects/ae-markers-settings.png)

3. В открывшемся окне измените комментарий маркера на `OUT`.

![Marker OUT 1](../images/1.1.6/working-with-third-party-software/after-effects/ae-markers-out-marker-1.png)

4. Переместите ползунок в середину композиции и поставьте следующий маркер.

![Second Marker](../images/1.1.6/working-with-third-party-software/after-effects/ae-markers-second-marker.png)

5. Измените комментарий маркера на `IN`

![Marker IN 1](../images/1.1.6/working-with-third-party-software/after-effects/ae-markers-in-marker-1.png)

![Marker IN 2](../images/1.1.6/working-with-third-party-software/after-effects/ae-markers-in-marker-2.png)

6. Переместите ползунок в конец композиции и поставьте следующий маркер.

![Third Marker](../images/1.1.6/working-with-third-party-software/after-effects/ae-markers-third-marker.png)

7. Измените комментарий маркера на `OUT`.

![Marker OUT 2](../images/1.1.6/working-with-third-party-software/after-effects/ae-markers-out-marker-2.png)

Расположение маркеров будет выглядеть следующим образом:

![Active Markers](../images/1.1.6/working-with-third-party-software/after-effects/ae-markers-active-markers.png)
...
![Additional Markers 1](../images/1.1.6/working-with-third-party-software/after-effects/ae-markers-additional-markers-1.png)
...
![Key Position](../images/1.1.6/working-with-third-party-software/after-effects/ae-animation-key-position.png)
...
![Key Expressions](../images/1.1.6/working-with-third-party-software/after-effects/ae-animation-key-expressions.png)
...
![Export Carrot Template](../images/1.1.6/working-with-third-party-software/after-effects/ae-export-export-carrot-template.png)
...
![Template Preview Animation](../images/1.1.6/working-with-third-party-software/after-effects/ae-export-tp-animation.png)

3. В поле `Composition` выберите композицию, которая была экспортирована:

![Template Preview Composition](../images/1.1.6/working-with-third-party-software/after-effects/ae-export-tp-composition.png)
...
![Additional Markers 2](../images/1.1.6/working-with-third-party-software/after-effects/ae-markers-additional-markers-2.png)

4. Проверьте правильность воспроизведения анимации:

- Нажмите на название стейта.

![Start Animation](../images/1.1.6/working-with-third-party-software/after-effects/ae-export-tp-start-animation.png)

- Дождитесь завершения проигрывания.

5. Нажмите кнопку `Save Template`.

![Save Template Button](../images/1.1.6/working-with-third-party-software/after-effects/ae-export-save-template-button.png)
...
![Export Scheme Carrot Engine](../images/1.1.6/working-with-third-party-software/after-effects/ae-export-scheme-carrot-engine.png)
...
![Media Layer Variable](../images/1.1.6/working-with-third-party-software/after-effects/ae-variables-layers.png)

![Text Layer Variable](../images/1.1.6/working-with-third-party-software/after-effects/ae-variables-text-layer.png)
...
![Variable Drag and Drop](../images/1.1.6/working-with-third-party-software/after-effects/ae-variables-drag-and-drop.png)

- Выберите созданную переменную
- В поле `Name` введите желаемое имя переменной.

![Variable Properties](../images/1.1.6/working-with-third-party-software/after-effects/ae-variables-properties.png)

- В поле `Type` укажите необходимый тип переменной.

#### Создание текстовой переменной

![Text Variable Dashboard](../images/1.1.6/working-with-third-party-software/after-effects/ae-text-variable-dashboard.gif)
...
![Text Variable Drag and Drop](../images/1.1.6/working-with-third-party-software/after-effects/ae-text-variable-drag-and-drop.png)
...
>
> ![Text Variable Drag and Drop](../images/1.1.6/working-with-third-party-software/after-effects/ae-text-variable-rich-text.png)
...
![Epic Games Launcher Installing](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-installing-egl-epic-games-launcher.jpg)
...
![Epic Games Launcher Authentication](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-installing-egl-authentication.jpg)
...
![Epic Games Launcher Settings](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-installing-egl-settings.jpg)
...
![Epic Games Launcher Parameters](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-installing-egl-parameters.jpg)
...
![Unreal Engine Library](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-installing-library.jpg)

2. Нажать кнопку `+` и выпадающем списке выбрать необходимую версию **Unreal Engine**.

![Unreal Engine Version](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-installing-version.jpg)
...
>
> ![Unreal Engine Additional Parameters](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-installing-additional-parameters.jpg)
...
![Unreal Engine Launch](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-create-project-launch.jpg)
...
![Unreal Engine Create Project](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-create-project-creating.jpg)
...
![Carrot Unreal Engine Plugin Folder](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-installing-plugin-folder.jpg)
...
![Carrot Unreal Engine Plugin in Project](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-installing-plugin-project.jpg)
...
![Creating Empty Level](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-configuration-empty-level.jpg)
...
![Unreal Engine Window Configuration](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-configuration-windows.jpg)
...
![Unreal Engine Outliner Parameter](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-configuration-outliner.jpg)

![Unreal Engine Content Drawer Parameter](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-configuration-content-drawer.jpg)
...
![Adding Actor Component](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-actor.jpg)

![Adding Cine Camera Actor Component](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-cine-camera.jpg)

![Adding Post Process Volume Component](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-post-process.jpg)
...
![Outliner Details](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-outliner-details.jpg)
...
![Outliner Rename](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-outliner-rename.jpg)
...
![Carrot Camera Parameters](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-carrot-camera.jpg)
...
![Post Process Volume Settings 1](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-post-process-1.jpg)

![Post Process Volume Settings 2](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-post-process-2.jpg)
...
![Open Level Blueprint](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-blueprint-open.jpg)
...
>
> ![Event Graph in Level Blueprint](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-blueprint-graph.jpg)
>
...
![Making Conjunction in Level Blueprint](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-blueprint-conjunction.jpg)

8. В появившемся окне **Executable actions** с помощью поисковой строки найти ноду `Carrot Macro` и добавить её.

![Adding Carrot Macro in Level Blueprint](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-blueprint-carrot-macro.jpg)
...
![Adding Components to Level Blueprint](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-blueprint-components.jpg)
...
![Adding Switch on String to Level Blueprint](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-blueprint-switch-on-string.jpg)
...
![Adding Pins to Switch on String](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-blueprint-add-pin.jpg)
...
>
> ![Error in Carrot Macro](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-blueprint-carrot-macro-error.jpg)
>
...
>
> ![Fixing Error in Carrot Macro](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-project-preparation-blueprint-carrot-macro-fixing.jpg)
...
> ![RTT Example](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-rtt-example.jpg)
>
...
![Creating RTT](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-rtt-creating.jpg)
...
![Assigning Parameters in RTT](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-rtt-assigning-parameters.jpg)
...
>
> ![Creating Material for RTT](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-rtt-creating-material.jpg)
...
![Open Level Blueprint](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-rtt-open-level-blueprint.png)
...
![Adding Carrot Receiver to Level Blueprint](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-rtt-blueprint-carrot-receiver.jpg)
...
![Compiling the Level Blueprint](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-rtt-blueprint-compile.jpg)
...
![Adding Material to RTT](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-rtt-adding-meterial-to-rtt.jpg)
...
![Export Unreal Engine Project to Template](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-export-process.jpg)
...
![Creating Events in Carrot Dashboard](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-events-creating-in-dahsboard.jpg)
...
![Assigning a Media to the RTT Variable](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-events-assign-media.jpg)
...
![Laucnhing the Event](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-events-launch.jpg)
...
![Result in Carrot Engine](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-events-carrot-engine.jpg)
...
![Open Level Blueprint](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-variables-open-level-blueprint.jpg)
...
![Creating Variables in Level Blueprint](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-variables-creating-variables.jpg)
...
![Saving Unreal Engine Variables](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-variables-saving-variables.jpg)
...
![Activate Parameter in Carrot Dashboard](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-variables-parameter-in-carrot-dashboard.jpg)
...
1. Открыть **окно Editor**, выбрать один из добавленных ивентов (в примере используется ивент с именем `SHOW`), включить режим редактирования переменных `Allow Runtime Change` в разделе **Event Properties**  и нажать кнопку `Apply`.

![Turn on Allow Runtime Change Parameter in Event](../images/1.1.6/working-with-third-party-software/unreal-engine/ue-variables-event-parameters-carrot-dashboard.jpg)
