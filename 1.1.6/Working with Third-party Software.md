...
В данном разделе можно ознакомиться с принципами работы **Carrot** с **After Effects 2022** и **Unreal Engine**.
...
>
>Также необходимо убедиться, что точки анимации в проекте After Effects расставлены в необходимых местах и соответствуют установленному времени воспроизведения, так как при изменении кадровой частоты экспортируемой композиции изменяется и данный параметр.
