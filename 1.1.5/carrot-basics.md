...
![Carrot Server Main Window](../images/1.1.5/carrot-basics/carrot-server/cs-ui-main-window.png)
...
![Carrot Server Buttons](../images/1.1.5/carrot-basics/carrot-server/cs-ui-buttons.png)
...
![Carrot Server File Button](../images/1.1.5/carrot-basics/carrot-server/cs-ui-file-button.png)
...
![Carrot Server Settings](../images/1.1.5/carrot-basics/carrot-server/cs-ui-settings.png)
...
![Carrot Server Settings](../images/1.1.5/carrot-basics/carrot-server/cs-ui-tools-buttons.png)
...
![Carrot Server Help Button](../images/1.1.5/carrot-basics/carrot-server/cs-ui-help-button.png)
...
![Carrot Server About Window](../images/1.1.5/carrot-basics/carrot-server/cs-ui-about-window.png)

#### Область "Основное рабочее пространство Carrot Server"

![Carrot Server Main Workspace](../images/1.1.5/carrot-basics/carrot-server/cs-ui-main-workspace.png)
...
![Carrot Server Replication Toolbar](../images/1.1.5/carrot-basics/carrot-server/cs-ui-replication-toolbar.png)
...
![Carrot Server Replication Settings](../images/1.1.5/carrot-basics/carrot-server/cs-replication-settings.jpg)
...
![Carrot Server Replication Server 1](../images/1.1.5/carrot-basics/carrot-server/cs-replication-server-1.png)
...
![Carrot Server Replication Server 2](../images/1.1.5/carrot-basics/carrot-server/cs-replication-server-2.png)
...
![Carrot Server Check Other Servers](../images/1.1.5/carrot-basics/carrot-server/cs-replication-cos-button.png)
...
![Carrot Server Set Server As Master](../images/1.1.5/carrot-basics/carrot-server/cs-replication-ssam-button.png)
...
![Launcher Main Window](../images/1.1.5/carrot-basics/launcher/l-ui-main-window.png)
...
![Launcher File Button](../images/1.1.5/carrot-basics/launcher/l-ui-file-button.png)
...
![Launcher Settings Window](../images/1.1.5/carrot-basics/launcher/l-ui-settings-window.png)
...
![Launcher Tools Button](../images/1.1.5/carrot-basics/launcher/l-ui-tools-button.png)
...
![Workstation Registration Window](../images/1.1.5/carrot-basics/launcher/l-ui-wr-window.png)
...
![Workstation Registration File Button](../images/1.1.5/carrot-basics/launcher/l-ui-wr-file-button.png)
...
![Workstation Registration Area](../images/1.1.5/carrot-basics/launcher/l-ui-wr-area.png)
...
>
> ![Launcher Workstation Window](../images/1.1.5/carrot-basics/launcher/l-ui-workstation-window.png)
>
...
![Workstation Registration Input-output Area](../images/1.1.5/carrot-basics/launcher/l-ui-wr-input-output-area.png)
...
![Launcher Help Button](../images/1.1.5/carrot-basics/launcher/l-ui-help-button.png)
...
![Launcher About Window](../images/1.1.5/carrot-basics/launcher/l-ui-about-window.png)
...
![System Monitor Main Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-main-window.png)
...
![System Monitor Buttons](../images/1.1.5/carrot-basics/system-monitor/sm-ui-buttons.png)
...
![System Monitor File Button](../images/1.1.5/carrot-basics/system-monitor/sm-ui-file-button.png)
...
![System Monitor Settings](../images/1.1.5/carrot-basics/system-monitor/sm-ui-settings.png)
...
![System Monitor Help Button](../images/1.1.5/carrot-basics/system-monitor/sm-ui-help-button.png)
...
![System Monitor About Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-about-window.png)

#### Область "Основные вкладки System Monitor"

![System Monitor Tabs Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-area.png)
...
![System Monitor Workstations Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-workstations.png)
...
![System Monitor Workstations Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-w-workstations-area.png)
...
![System Monitor Workstations Elements](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-w-workstations-elements.png)
...
>
> ![System Monitor Enter Folder Name Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-enter-folder-name-window.png)
>
...
![System Monitor Workstations Carrot Engine Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-w-rs-carrot-engine-area.png)
...
![System Monitor Workstations Carrot Engine Elements](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-w-rs-carrot-engine-elements.png)
...
![System Monitor Engines Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-engines.png)
...
![System Monitor Engines Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-e-s-engines-area.png)
...
![System Monitor Engines Elements](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-e-s-engines-elements.png)
...
> Внешний вид окна создания папок после взаимодействия с кнопкой `Add Folder` представлен на рисунке ниже.
>
> ![System Monitor Enter Folder Name Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-folder-name-window.png)
>
> Для создания папки, необходимо в поле **"Enter folder name"** ввести требуемое наименование и нажать кнопку `OK`.
>
> Для прерывания процесса создания папки, необходимо нажать кнопку `Cancel`.
...
>
> ![System Monitor Enter Engine Name Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-engine-name-window.png)
>
...
![System Monitor Related Workstations Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-e-rw-area.png)
...
![System Monitor Related Workstations Elements](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-e-rw-elements.png)
...
>
> ![System Monitor Workstations Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-workstations-window.png)
...
![System Monitor Engine Flowchart](../images/1.1.5/carrot-basics/system-monitor/sm-ui-ef.png)
...
![System Monitor Engine Flowchart Nodes](../images/1.1.5/carrot-basics/system-monitor/sm-ui-ef-nodes.png)
...
![System Monitor Users & Groups Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-user-groups.png)
...
![System Monitor Groups Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-ug-groups-area.png)
...
![System Monitor Groups Elements](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-ug-group-elements.png)
...
>
> ![System Monitor Enter User Group Name Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-enter-user-group-name-window.png)
>
...
![System Monitor Role Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-ug-role-area.png)

**Область "Предоставляемые права (роли) (Role)"** предназначена для указания прав (ролей) выбранной пользовательской группе.

![System Monitor Role Elements](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-ug-role-elements.png)
...
![System Monitor Users Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-ug-users-area.png)
...
![System Monitor Users Elements](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-ug-users-elements.png)
...
>
> ![System Monitor Creating New User Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-creating-new-user-window.png)
>
...
![System Monitor User Data Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-ug-user-data-area.png)
...
![System Monitor User Data Elements](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-ug-user-data-elements.png)
...
![System Monitor Launcher Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-launcher.png)
...
![System Monitor Launcher Engines Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-l-s-carrot-engine-area.png)
...
![System Monitor Launcher Workstations Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-l-workstations-area.png)

Область **"Рабочие станции (Workstations)"** предназначена для запуска связанных рабочих станций со схемой **Carrot Engine**.

![System Monitor Launcher Workstations Elements](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-l-workstation-elements.png)
...
>
> ![System Monitor Launcher Running Workstation](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-l-running-workstation.png)
>
...
![System Monitor Keyer Settings Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-keyer-settings.png)
...
![System Monitor Keyer Nodes Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-ks-keyer-nodes-area.png)
...
![System Monitor Keyer Nodes Elements](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-ks-keyer-nodes-elements.png)
...
![System Monitor Keyer Options Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-ks-keyer-options-area.png)
...
![System Monitor Channels Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-channels.png)
...
![System Monitor Channels Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-c-channels-area.png)

Область **"Каналы"** предназначена для создания каналов и взаимодействия с ними.

![System Monitor Channels Elements](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-c-channels-elements.png)
...
>
> ![System Monitor Enter Channel Name Window](../images/1.1.5/carrot-basics/system-monitor/sm-ui-channel-name-window.png)
>
...
![System Monitor Roles Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-c-roles-area.png)

Область **"Пользовательские группы"** предназначена для отображения списка созданных пользовательских групп.

###### Область "Пользователи"

![System Monitor Users Area](../images/1.1.5/carrot-basics/system-monitor/sm-ui-fw-c-users-area.png)
...
![Carrot Dashboard Authentication Window](../images/1.1.5/carrot-basics/web-playlist/wp-auth-window.png)
...
![Web Playlist Server Window](../images/1.1.5/carrot-basics/web-playlist/wp-ui-server-window.png)
...
![Web Playlist Main Window](../images/1.1.5/carrot-basics/web-playlist/wp-ui-main-window.png)
...
![Web Playlist User Area](../images/1.1.5/carrot-basics/web-playlist/wp-ui-user-area.png)

![Web Playlist User Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-user-elements.png)
...
![Web Playlist Playlist Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-playlist-elements.png)
...
![Web Playlist Playlist Buttons Area](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-p-buttons-area.png)
...
![Web Playlist Playlist Buttons Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-p-buttons-elements.png)
...
![Web Playlist Playlist Directory Area](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-p-directory-area.png)
...
![Web Playlist Playlist Directory Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-p-directory-elements.png)
...
>
> ![Web Playlist Open existing playlist Window Area](../images/1.1.5/carrot-basics/web-playlist/wp-ui-open-existing-playlist-window-area.png)
>
> ![Web Playlist Open existing playlist Window Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-open-existing-playlist-window-elements.png)
>
...
![Web Playlist Playlist Interaction Area](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-p-interaction-area.png)
...
![Web Playlist Playlist Interaction Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-p-interaction-elements.png)
...
> ![Web Playlist Playlist Event Types](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-p-gi-events.png)
>
>
...
![Web Playlist Editor Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-editor-elements.png)
...
![Web Playlist Editor New Playlist Button](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-e-new-playlist-button.png)
...
![Web Playlist Create an empty playlist Window Area](../images/1.1.5/carrot-basics/web-playlist/wp-ui-create-an-empty-playlist-window-area.png)

> ![Web Playlist Create an empty playlist Window Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-create-an-empty-playlist-window-elements.png)
>
...
![Web Playlist Editor Open Playlist Button](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-e-open-playlist-button.png)
...
![Web Playlist Editor Available Playlist Area](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-e-available-playlist-area.png)
...
![Web Playlist Editor Available Playlist Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-e-available-playlist-elements.png)
...
![Web Playlist Editor Playlist Stories Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-e-playlist-stories-elements.png)
...
![Web Playlist Editor Playlist Manager Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-e-playlist-manager-elements.png)
...
> ![Web Playlist Editor Template Manager Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-e-pm-template-manager-elements.png)
>
...
> ![Web Playlist Editor Event Manager Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-e-pm-event-manager-elements.png)
>
...
>
> ![Web Playlist Editor Global Event Pool Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-e-pm-global-event-pool-elements.png)
>
...
> ![Web Playlist Editor Event Properties Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-e-pm-event-properties-elements.png)
>
...
![Web Playlist Browser Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-browser-elements.png)
...
![Web Playlist Browser Buttons Area](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-b-buttons-area.png)
...
![Web Playlist Browser Buttons Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-b-buttons-elements.png)
...
![Web Playlist Browser Media Area](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-b-oi-media-area.png)
...
![Web Playlist Browser Templates Area](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-b-oi-templates-area.png)
...
![Web Playlist Browser Playlists Area](../images/1.1.5/carrot-basics/web-playlist/wp-ui-fw-b-oi-playlists-area.png)
...
![Web Playlist Settings Window](../images/1.1.5/carrot-basics/web-playlist/wp-ui-settings-window.png)
...
![Web Playlist Settings Elements](../images/1.1.5/carrot-basics/web-playlist/wp-ui-settings-elements.png)
...
- `File` - `Settings` - открывает настройки Launcher. Подробнее о данном пункте можно прочитать здесь.
...
- `Tools` - `Workstation Registration` - открывает окно Workstation Registration, подробнее о его настройке можно прочитать здесь.
...
![Carrot Engine Input Signal](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-input-signal.png)

*Результат без настроек кеера*:

![Carrot Engine Signal After Keying](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-signal-after-keying.png)

*После настройки кеера*:

![Carrot Engine Signal After Keyer Settings](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-signal-after-keyer-settings.png)
...
![Carrot Engine Open Keyer Setting](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-open-keyer-settings.png)
...
![Carrot Engine Keyer Setting Modes](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-modes-keyer-settings.png)
...
![Carrot Engine Hystogram Location](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-histogram.png)
...
![Carrot Engine DeNoise Result](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-denoise-result.png)

> Чтобы вернуть настройки по умолчанию, нажмите **ПКМ** по области стрелок нужного счетчика.

Режим _Final Result_:

![Carrot Engine Final Result](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-final-result.png)
...
![Carrot Engine DeSpill Result](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-despill-result.png)
...
![Carrot Engine Inner Mask Result](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-inner-mask-result.png)

_Alpha Mask_

![Carrot Engine Alpha Mask Result](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-alpha-mask-result.png)

_Screen Restoration_

![Carrot Engine Screen Restoration Result](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-screen-restoration-result.png)
...
![Carrot Engine Final Result After Settings](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-final-result-after-settings.png)
...
![Carrot Engine Environment Light Result](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-environment-light-result.png)

_Environment Overlay_

![Carrot Engine Environment Overlay Result](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-environment-overlay-result.png)

Итоговый результат:

![Carrot Engine Final Result with All Settings](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-final-result-all-settings.png)
...
![Carrot Engine Keyer Settings in System Monitor](../images/1.1.5/carrot-basics/carrot-engine/ce-ks-system-monitor-keyer-settings.jpg)
...
![Carrot Engine AR Edit Scheme Location](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-edit-scheme.png)
...
![Carrot Engine AR Scheme](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-scheme.png)
...
![Carrot Engine AR Sphere Unreal Engine](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-sphere-unreal-engine.png)
...
![Carrot Engine AR Material Unreal Engine](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-material-unreal-engine.png)
...
![Carrot Engine AR Mask Material Unreal Engine](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-mask-material-unreal-engine.png)

Пример материала для теней и отражений:

![Carrot Engine AR Effects Material Unreal Engine](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-effects-material-unreal-engine.png)

Пример Blueprint Actor:

![Carrot Engine AR Actor Blueprint Unreal Engine](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-actor-blueprint-unreal-engine.png)
...
![Carrot Engine AR Object Settings Unreal Engine](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-object-settings-unreal-engine.png)

Результат работы в Carrot Engine с CustomStencil 255 и без:

![Carrot Engine AR Custom Stencil Unreal Engine](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-custom-stencil-unreal-engine.png)
...
![Carrot Engine AR Mask Custom Depth Unreal Engine](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-mask-custom-depth-unreal-engine.png)

Результат работы масок:

![Carrot Engine AR Mask Using Unreal Engine](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-mask-using-unreal-engine.png)
...
![Carrot Engine AR Show Content Settings](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-show-content-settings.png)

Откроется окно настроек AR

![Carrot Engine AR Settings Window](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-ar-settings-window.png)
...
![Carrot Engine AR Cubemap Unreal Engine](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-cubemap-unreal-engine.jpeg)
...
![Carrot Engine AR Vignette Unreal Engine](../images/1.1.5/carrot-basics/carrot-engine/ce-ar-vignette-unreal-engine.jpeg)
...
![Carrot Engine Luma Texture](../images/1.1.5/carrot-basics/carrot-engine/ce-l-texture.jpg)

![Carrot Engine Luma Scheme](../images/1.1.5/carrot-basics/carrot-engine/ce-l-scheme.jpg)

2. Запустим движок.

![Carrot Engine Luma Scheme Launch](../images/1.1.5/carrot-basics/carrot-engine/ce-l-launch-scheme.jpg)
...
![Carrot Engine Luma Mask Settings 1](../images/1.1.5/carrot-basics/carrot-engine/ce-l-mask-settings-1.jpg)

![Carrot Engine Luma Mask Settings 1](../images/1.1.5/carrot-basics/carrot-engine/ce-l-mask-settings-2.jpg)

7. Итог.

![Carrot Engine Luma Launch Result](../images/1.1.5/carrot-basics/carrot-engine/ce-l-launch-result.jpg)
...
![Carrot Engine LUT Window](../images/1.1.5/carrot-basics/carrot-engine/ce-lut-lut-utils-window.jpg)
...
![Carrot Engine LUT Color Table](../images/1.1.5/carrot-basics/carrot-engine/ce-lut-color-table.jpg)
...
![Carrot Engine LUT Color Table](../images/1.1.5/carrot-basics/carrot-engine/ce-lut-filename-settings.jpg)

10. Выберите экспортированный `LUT` файл.
11. Готово.

![Carrot Engine LUT Result](../images/1.1.5/carrot-basics/carrot-engine/ce-lut-result.jpg)
...
![Carrot Engine GPIO Window](../images/1.1.5/carrot-basics/carrot-engine/ce-gpio-window.jpg)

4. Раскройте меню `Playlist`, чтобы выбрать плейлист для управления через контроллер.

![Carrot Engine GPIO Playlist](../images/1.1.5/carrot-basics/carrot-engine/ce-gpio-playlist.jpg)

5. Из региона `Playlist Events` перенесите события в регион `Assigned Events`.

![Carrot Engine GPIO Events](../images/1.1.5/carrot-basics/carrot-engine/ce-gpio-events.jpg)
...
![Carrot Engine GPIO Cmd](../images/1.1.5/carrot-basics/carrot-engine/ce-gpio-cmd.jpg)
...
![Carrot Engine Input Device in Trey](../images/1.1.5/carrot-basics/carrot-engine/ce-id-trey.jpg)
...
![Carrot Engine Input Device Network Settings](../images/1.1.5/carrot-basics/carrot-engine/ce-id-network-settings.jpg)
...
![Datastream Server Tables Location](../images/1.1.5/carrot-basics/datastream-server/ds-work-tables-location.jpg)

2. Нажимаем `Add Table` (*Если необходимо удалить созданную таблицу нажимаем* `Delete Table`).

![Datastream Server Add Table](../images/1.1.5/carrot-basics/datastream-server/ds-work-add-table.jpg)
...
![Datastream Server Table Name](../images/1.1.5/carrot-basics/datastream-server/ds-work-table-name.jpg)
...
![Datastream Server Add Cell](../images/1.1.5/carrot-basics/datastream-server/ds-work-add-cell.jpg)
...
![Datastream Server Name Property](../images/1.1.5/carrot-basics/datastream-server/ds-work-name-property.jpg)

6. В `After Effects` перейдём в `Export Carrot Template`.

![Datastream Server After Effects Export Carrot Tamplate](../images/1.1.5/carrot-basics/datastream-server/ds-work-ae-export-carrot-template.jpg)
...
![Datastream Server After Effects Variables](../images/1.1.5/carrot-basics/datastream-server/ds-work-ae-variables.gif)
...
![Datastream Server Adding Variable in Carrot Dashboard](../images/1.1.5/carrot-basics/datastream-server/ds-work-cd-adding-variable.gif)
...
![Datastream Server Adding Value to Variable](../images/1.1.5/carrot-basics/datastream-server/ds-work-adding-value-to-variable.gif)

![Datastream Server Local Variable Result](../images/1.1.5/carrot-basics/datastream-server/ds-work-local-result.jpg)
...
![Datastream Server Add Plugin Location](../images/1.1.5/carrot-basics/datastream-server/ds-work-add-plugin-location.gif)
...
![Datastream Server Add Rule Location](../images/1.1.5/carrot-basics/datastream-server/ds-work-add-rule-location.jpg)

4. Создадим текстовый документ. Внесём в него переменные через "<>". Вводим значения или текст. Сохраняем заменив `.txt` на `.xml`.

![Datastream Server XML File](../images/1.1.5/carrot-basics/datastream-server/ds-work-xml-file.jpg)
...
![Datastream Server Activate Rule](../images/1.1.5/carrot-basics/datastream-server/ds-work-activate-rule.jpg)
...
![Datastream Server Edit Cells](../images/1.1.5/carrot-basics/datastream-server/ds-work-edit-cells.gif)

7. Перейдём в `Tables`. Наши ячейки автоматически поменяли значения подставив их из XML-файла.

![Datastream Server XML Cells](../images/1.1.5/carrot-basics/datastream-server/ds-work-xml-cells.jpg)

8. Проделаем действия из "Первого типа" пункт 8.

![Datastream Server XML Result](../images/1.1.5/carrot-basics/datastream-server/ds-work-xml-cells-result.gif)
...
![Datastream Server XLSX File](../images/1.1.5/carrot-basics/datastream-server/ds-work-xlsx-file.jpg)
...
![Datastream Server XLSX File](../images/1.1.5/carrot-basics/datastream-server/ds-work-xlsx-activate.jpg)
...
![Datastream Server XLSX File](../images/1.1.5/carrot-basics/datastream-server/ds-work-xlsx-cells-result.gif)
...
![Datastream Server Call Back](../images/1.1.5/carrot-basics/datastream-server/ds-work-call-back.gif)
