...
7. Раздел `Replication`, включает следующие поля для редактирования:
...
![Settings_Carrot Server_Settings](..\images\3998\image_001.jpg "Carrot Server - Settings")
...
- `Reconnect using IP address` если `True`, повторное подключение к резервному веб-серверу будет использовать IP-адрес; если `False` — имя машины.
...
![Settings_Carrot WebPlaylist](..\images\3998\image_006.jpg "Carrot WebPlaylist")
